...
const ScrollingCards = () => {
    ...
    const ImageCard = ({ src, idx }) => (
        <motion.div
            ...
            className="flex-shrink-0 w-[320px] h-[220px] rounded-2xl overflow-hidden shadow-2xl"
        >
            <img src={src} alt={`Jewelry ${idx}`} className="w-full h-full object-cover" />
        </motion.div>
    );
    ...
    return (
      ...
      `}</style>
            ...
            <motion.div
                ...
                className="text-center mb-16 px-4"
            >
                <h2 className="text-6xl font-bold mb-4 bg-gradient-to-r from-amber-600 via-rose-500 to-pink-600 bg-clip-text text-transparent">
            ...
            {/* Center Buttons */}
            <div className="relative h-[200px] flex items-center justify-center mb-16">
                ...
                <div className="relative z-10 flex flex-col gap-4">
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="px-8 py-4 bg-gradient-to-r from-amber-500 to-orange-600 text-white font-semibold text-lg rounded-full shadow-xl hover:shadow-2xl transition-all duration-300"
                    >
                        Visit Gallery
                    </motion.button>
                    ...
                    <motion.button
                        whileHover={{ scale: 1.1 }}
                        whileTap={{ scale: 0.95 }}
                        className="px-8 py-4 bg-gradient-to-r from-pink-500 to-rose-600 text-white font-semibold text-lg rounded-full shadow-xl hover:shadow-2xl transition-all duration-300"
                    >
                        Follow us on Instagram
                    </motion.button>
                </div>
            ...
            <div className="relative overflow-hidden mb-16">
                <div className="flex gap-6 animate-scroll-left">
                    {[...imageCards1, ...imageCards1].map((img, idx) => (
                        <ImageCard key={idx} src={img} idx={idx} />
                    ))}
                </div>
            </div>
            ...
            <div className="relative overflow-hidden">
                <div className="flex gap-6 animate-scroll-left">
                    {[...imageCards3, ...imageCards3].map((img, idx) => (
                        <ImageCard key={idx} src={img} idx={idx} />
                    ))}
                </div>
            </div>
